...
var_dump(constant("URL_LOCAL_BASE"));
echo"<br/>";
var_dump(constant("URL_LOCAL_IMG"));
echo"<br/>";
var_dump(constant("URL_LOCAL_SITE"));
echo"<br/>";
var_dump(constant("URL_LOCAL_EMAIL_ACESSO"));
echo"<br/>";
var_dump(constant("URL_LOCAL_EMAIL_LOGO"));
?>